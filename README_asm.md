...
The two-pass approach is essential for handling forward references to labels, ensuring that all symbols are resolved correctly regardless of where they appear in the code.